...
@InputType()
class AvaliaOPessoalCreateNestedManyWithoutUsuRiosInput {
...
export { AvaliaOPessoalCreateNestedManyWithoutUsuRiosInput as AvaliaOPessoalCreateNestedManyWithoutUsuRiosInput };

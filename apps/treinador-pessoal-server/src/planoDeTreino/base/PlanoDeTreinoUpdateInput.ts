...
@InputType()
class PlanoDeTreinoUpdateInput {
  @ApiProperty({
    required: false,
    type: String,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ExercCioUpdateManyWithoutPlanoDeTreinosInput,
  })
  @ValidateNested()
  @Type(() => ExercCioUpdateManyWithoutPlanoDeTreinosInput)
  @IsOptional()
  @Field(() => ExercCioUpdateManyWithoutPlanoDeTreinosInput, {
    nullable: true,
  })
...
export { PlanoDeTreinoUpdateInput as PlanoDeTreinoUpdateInput };

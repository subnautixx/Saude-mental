...
@InputType()
class DesempenhoDoUsuRioCreateNestedManyWithoutExercCiosInput {
...
export { DesempenhoDoUsuRioCreateNestedManyWithoutExercCiosInput as DesempenhoDoUsuRioCreateNestedManyWithoutExercCiosInput };

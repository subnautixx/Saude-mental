...
@InputType()
class CompartilhamentoSocialCreateNestedManyWithoutUsuRiosInput {
...
export { CompartilhamentoSocialCreateNestedManyWithoutUsuRiosInput as CompartilhamentoSocialCreateNestedManyWithoutUsuRiosInput };

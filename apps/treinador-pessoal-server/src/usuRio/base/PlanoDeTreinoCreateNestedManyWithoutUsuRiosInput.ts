...
@InputType()
class PlanoDeTreinoCreateNestedManyWithoutUsuRiosInput {
...
export { PlanoDeTreinoCreateNestedManyWithoutUsuRiosInput as PlanoDeTreinoCreateNestedManyWithoutUsuRiosInput };
